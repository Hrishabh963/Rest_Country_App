...
const Input = ({handleChange,handleSelect,handleSubRegionSelect,countryData,region,toggleSort}) => {
  ...
  return (
    <div className='flex flex-col w-[95vw] justify-between pl-4 desktop:flex-row desktop:pl-16 bg-White dark:bg-Very_Dark_Blue pb-4'>
      ...
      <Select handleSelect={toggleSort} optionValues={['ascending','descending']} defaultValue="Sort by population" />
       <Select handleSelect={handleSelect} optionValues={continents} defaultValue="Filter By region" />
       <Select handleSelect={handleSubRegionSelect} optionValues={subRegions} defaultValue="Filter By subregion" />
      </div>
    </div>
  )
}
