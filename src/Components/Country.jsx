...
const Country = ({name,flag,population,capital,region}) => {
  ...
  return (
    <div className='flex flex-col drop-shadow-lg h-fit w-4/6 my-6 rounded-lg bg-White desktop:basis-[19%] desktop:h-96 desktop:mx-10 dark:bg-Dark_Blue cursor-pointer'>
    <img src={flag} alt={name} className='rounded-t-lg w-full h-[55%]' />
     <div className='flex flex-col pl-4 pt-4 pb-11'>
