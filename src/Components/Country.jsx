...
const Country = ({name,flag,population,capital,region}) => {
  ...
  return (
    <div className='flex flex-col drop-shadow-lg h-fit w-4/6 my-6 rounded-lg bg-White desktop:basis-[19%] desktop:h-96 desktop:mx-7 dark:bg-Dark_Blue cursor-pointer'>
