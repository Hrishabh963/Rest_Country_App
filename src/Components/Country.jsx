...
const Country = ({name,flag,population,capital,region,cca2}) => {
  const populationFormat = population.toLocaleString('en-US');  
  return (
      <div id={cca2} className='flex flex-col drop-shadow-lg h-fit w-4/6 my-6 rounded-lg bg-White desktop:basis-[19%] desktop:h-96 desktop:mx-10 dark:bg-Dark_Blue cursor-pointer transform ease-in-out duration-150 hover:-translate-y-3 country_item'>
